...
test('When the Clip progresses the subscribed listeners should be informed', () => {
    ...
    myClip.onProgress(10 / 1000, 10);
    myClip.onProgress(20 / 1000, 20);
    myClip.onProgress(50 / 1000, 50);
    myClip.onProgress(500 / 1000, 500);
    myClip.onProgress(40 / 1000, 40);
...
test('Test threshold on progress subscribers', () => {
    ...
    myClip.onProgress(0, 0);
    myClip.onProgress(60 / 1000, 60);
    myClip.onProgress(100 / 1000, 100);
    myClip.onProgress(200 / 1000, 200);
    myClip.onProgress(220 / 1000, 220);
    myClip.onProgress(240 / 1000, 240);
...
test('Test round on progress subscribers', () => {
    ...
    myClip.onProgress(60 / 1000, 60);
    myClip.onProgress(110 / 1000, 110);
    myClip.onProgress(140 / 1000, 140);
    myClip.onProgress(220 / 1000, 220);
    myClip.onProgress(240 / 1000, 240);
