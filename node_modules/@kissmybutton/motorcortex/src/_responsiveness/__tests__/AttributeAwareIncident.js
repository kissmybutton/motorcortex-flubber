...
const aai = new AttributesAwareIncident(di, contextData, 'specific-mcid', 'specific-mcid-targeting-selector');

test(`AttributeAwareIncident should set up one ContextAwareIncident on 0 position per attribute
