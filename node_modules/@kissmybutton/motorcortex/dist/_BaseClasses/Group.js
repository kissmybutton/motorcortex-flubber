...
var Node = require('../_Tree/Node');

var Channel = require('../_Channels/Channel');

var handleResize = require('./decorators/handleResize');
  ...
  return {
    ...
    d: [{
      ...
      value: function handleAddIncident(target, payload) {
        if (this.id === target) {
          var incidentFromDescription = require('../IncidentFromDefinition/incidentFromDescription');
