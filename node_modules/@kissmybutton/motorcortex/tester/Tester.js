            ...
            if (!actual.hasOwnProperty(laneKey)) {
                ...
                for (let i = 0; i < expected[laneKey].length; i++) {
                    ...
                    if (incidentPresent) {
                        ...
                        try {
                            if (typeof expectedLaneItem === "object") {
                                if (!compareObjects(expectedLaneItem.initialValue, incident.getInitialValue())) {
                                    errors.push({
                                ...
                                if (expectedLaneItem.initialValue !== incident.getInitialValue()) {
                                    errors.push({
                                        type: `LANES: initial value missmatch`,
                                        expected: expectedLaneItem.initialValue,
                                        actual: incident.getInitialValue(),
