 ...
 **/
function setInitialValue(lane, attribute, comboAttribute, incidentsById, newInitialValues, affectedIndex) {
...
&nbsp;
    const change = updateFinalValues(affectedIncident.getInitialValue(attribute), affectedIncident.originalAnimatedAttributeValue, affectedIncident.animatedAttributeValue);
&nbsp;
    ...
    if (change &amp;&amp; affectedIndex &lt; lane.length - 1) {
        ...
        setInitialValue(lane, attribute, comboAttribute, incidentsById, affectedIncident.animatedAttributeValue, affectedIndex + 1);
    }
}
&nbsp;
