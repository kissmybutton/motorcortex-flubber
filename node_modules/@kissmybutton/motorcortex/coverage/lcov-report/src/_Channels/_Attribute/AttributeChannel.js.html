...
<a name='L536'></a><a href='#L536'>536</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">15x</span>
...
&nbsp;
    ...
    moveTo(from, to, contextId, forceReset = <span class="branch-0 cbranch-no" title="branch not covered" >false)</span> {
        ...
        for (let i = 0; i &lt; laneKeys.length; i++) {
            ...
            else <span class="missing-if-branch" title="else path not taken" >E</span>if (from &gt; to) {
