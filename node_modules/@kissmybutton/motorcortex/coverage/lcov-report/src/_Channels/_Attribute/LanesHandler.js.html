...
<a name='L496'></a><a href='#L496'>496</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">15x</span>
...
&nbsp;
        ...
        if (newAnimsIndex === 0) { // if the newly entered animation is the first of the lane
            if (theLane.length &gt; 1) { // and it has other animations too
                <span class="missing-if-branch" title="else path not taken" >E</span>if (this.incidentsById._get(theLane[1].id).hasInitialValue(attr)) { // if the initial value of the following animation
                    // which used to be first is already calculated "steal" it
                    incident.setInitialValue(this.incidentsById._get(theLane[1].id).getInitialValue(attr));
                }
            }
...
&nbsp;
        ...
        if (Object.prototype.hasOwnProperty.call(this.comboAttributes, attr)) {
            ...
            setInitialValueForCombo(theLane, attr, this.comboAttributes[attr],
                this.incidentsById, incidentInitialValues, newAnimsIndex);
        }
&nbsp;
                ...
                if (animationIndexBeforeEdit !== animationIndexAfterEdit || animationIndexAfterEdit &gt; 1) {
                    if (animationIndexBeforeEdit + 1 &lt; lane.length) { // if the animation was not the last animation on the lane before the edit
                        ...
                        if (animationIndexBeforeEdit === 0) { // if the edited animation was the first one before the edit
                            ...
                            <span class="missing-if-branch" title="else path not taken" >E</span>if (animation.hasInitialValue(laneData.attribute) !== false) {
                                // get the initial value of the edited animation and set it as initial value of the new 0 index
                                if (isComboAttr) {
                                    setInitialValueForCombo(lane, laneData.attribute, this.comboAttributes[laneData.attribute],
                                        this.incidentsById, animation.getInitialValue(laneData.attribute), 0);
                                }
                                else {
                                    this.incidentsById._get(laneBeforeEdit[1].id).setInitialValue(animation.getInitialValue(laneData.attribute));
...
<span class="cstat-no" title="statement not covered" >                                    setInitialValueForCombo(lane, laneData.attribute, this.comboAttributes[laneData.attribute],</span>
                                        this.incidentsById, this.incidentsById._get(laneBeforeEdit[1].id).getScratchValue(), 0);
                                }
                                else {
...
<span class="cstat-no" title="statement not covered" >                                    this.incidentsById._get(laneBeforeEdit[1].id).onGetContext();</span>
                            ...
                            if (isComboAttr) {
                                ...
                                setInitialValueForCombo(lane, laneData.attribute, this.comboAttributes[laneData.attribute],
                                    this.incidentsById, this.incidentsById._get(laneBeforeEdit[animationIndexBeforeEdit - 1].id).animatedAttributeValue, indexToAffect);
                            }
                            else {
...
&nbsp;
                    ...
                    if (animationIndexAfterEdit === 0) { // is it the first one (after edit)?
                        ...
                        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.incidentsById._get(laneBeforeEdit[0].id).hasInitialValue(laneData.attribute)) {
                            // get the initial values of the previously 0 indexed animation of the lane
                            if (isComboAttr) {
                                setInitialValueForCombo(lane, laneData.attribute, this.comboAttributes[laneData.attribute],
                                    this.incidentsById, this.incidentsById._get(laneBeforeEdit[0].id).getInitialValue(laneData.attribute), animationIndexAfterEdit);
                            }
                            else {
                                animation.setInitialValue(this.incidentsById._get(laneBeforeEdit[0].id).getInitialValue(laneData.attribute));
...
<span class="cstat-no" title="statement not covered" >                            if (isComboAttr) {</span>
<span class="cstat-no" title="statement not covered" >                                setInitialValueForCombo(lane, laneData.attribute, this.comboAttributes[laneData.attribute],</span>
                                    this.incidentsById, animation.getScratchValue(), animationIndexAfterEdit);
                            }
                            else {
...
<span class="cstat-no" title="statement not covered" >                                animation.onGetContext();</span>
                        ...
                        if (isComboAttr) {
                            setInitialValueForCombo(lane, laneData.attribute, this.comboAttributes[laneData.attribute],
                                this.incidentsById, this.incidentsById._get(lane[animationIndexAfterEdit - 1].id).animatedAttributeValue, animationIndexAfterEdit);
                        }
                        else {
...
&nbsp;
                    ...
                    if (animationIndexAfterEdit + 1 &lt; lane.length) {
                        ...
                        if (isComboAttr) {
                            setInitialValueForCombo(lane, laneData.attribute, this.comboAttributes[laneData.attribute],
                                this.incidentsById, animation.animatedAttributeValue, animationIndexAfterEdit + 1);
                        }
                        else {
...
<span class="cstat-no" title="statement not covered" >                        delete affectedLanes[belongingLanes[j]];</span>
                    ...
                    if (animationIndexBeforeEdit &lt; lane.length &amp;&amp; this.incidentsById._get(animationToDelete.id).getInitialValue(laneData.attribute) !== false) {
                        if (Object.prototype.hasOwnProperty.call(this.comboAttributes, laneData.attribute)) {
                            setInitialValueForCombo(lane, laneData.attribute, this.comboAttributes[laneData.attribute],
                                this.incidentsById, this.incidentsById._get(animationToDelete.id).getInitialValue(laneData.attribute), animationIndexBeforeEdit);
                        }
                        else {
                            this.incidentsById._get(lane[animationIndexBeforeEdit].id).setInitialValue(this.incidentsById._get(animationToDelete.id).getInitialValue(laneData.attribute));
