  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>192/217</span>
      </div>
    </div>
    <p class="quiet">
...
<a name='L733'></a><a href='#L733'>733</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">11x</span>
...
&nbsp;
    unsubscribe(id) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (Object.prototype.hasOwnProperty.call(this.listeners, id)) {
...
&nbsp;
    // *******************************************************
    // STEP FUNCTION
<span class="fstat-no" title="function not covered" >    st</span>ep(timestamp) {
...
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (progress.fraction &gt;= 1 &amp;&amp; !this.hasIncidents) { // if it's not a Group as groups need to get completed through their incidents completion</span>
<span class="cstat-no" title="statement not covered" >            this.onProgress(1, this.duration);</span>
...
<span class="cstat-no" title="statement not covered" >            this.onProgress(0, 0);</span>
<span class="cstat-no" title="statement not covered" >            this.complete();</span>
            // this.broadcastEvent('state-change', { oldState: "playing", newState: "idle" });
<span class="cstat-no" title="statement not covered" >            return;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.onProgress(progress.fraction, progress.milliseconds);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.runTimeInfo.previousTimeStamp = timestamp;</span>
&nbsp;
...
&nbsp;
    // execution methods
    play() {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.runTimeInfo.state === 'idle' || this.runTimeInfo.state === 'paused') {
...
&nbsp;
    pause() {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.runTimeInfo.state === 'playing') {
