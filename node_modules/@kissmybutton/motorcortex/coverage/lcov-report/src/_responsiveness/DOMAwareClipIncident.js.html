...
<a name='L53'></a><a href='#L53'>53</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">10x</span>
...
&nbsp;
    _createElementIncident(element, descriptiveIncident, contextData, elementIndex, totalElements, mcid) {
        ...
        const constructionIngredients = {
            ...
            props: { ...constructionArguments.props, selector: contextData.context.getElementSelectorByMCID(mcid) },
